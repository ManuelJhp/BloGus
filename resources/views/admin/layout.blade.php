    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('admin.users.show', auth()->user()) }}" class="nav-link">Perfil</a>
                </li>
                @can('view', new App\Post)
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('admin.posts.index') }}" class="nav-link">Blogs</a>
                </li>
                @endcan
    ...
    <li class="nav-item dropdown user-menu">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <li class="user-header bg-primary">
                ...
                <p>
                    {{ ucfirst(auth()->user()->name) }} - {{ auth()->user()->getRoleDisplayNames() }}
            ...
            <li class="user-footer">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    {{ csrf_field() }}
                    <button class="btn btn-default btn-block float-right">Cerrar Sesion</button>
                </form>
            </li>
        </ul>
    </li>
   {{--  <li class="nav-item">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="./" class="brand-link">
            <img src="{{ asset('img/logo-footer.png')}}" alt="Logo" class="brand-image elevation-3">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{ asset('img/admin.png')}}" class="brand-image img-circle elevation-3">
                </div>
                <div class="info">
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; {{ \Carbon\Carbon::today()->toDateString() }} - {{ config('app.name') }}
            <a href="#">Todos los derechos reservados</a>
        </strong>
        <span class="c-white">- Diseñado y Desarrollado por Manuel Hierro</span>
    </footer>
    </div>
    <!-- ./wrapper -->
    <!-- REQUIRED SCRIPTS -->
